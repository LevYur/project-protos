...
const (
	CartService_AddToCart_FullMethodName      = "/cart.external.v1.CartService/AddToCart"
	CartService_RemoveFromCart_FullMethodName = "/cart.external.v1.CartService/RemoveFromCart"
	CartService_ClearCart_FullMethodName      = "/cart.external.v1.CartService/ClearCart"
	CartService_GetCart_FullMethodName        = "/cart.external.v1.CartService/GetCart"
)
...
type CartServiceClient interface {
	AddToCart(ctx context.Context, in *AddToCartRequest, opts ...grpc.CallOption) (*CartBoolResponse, error)
	RemoveFromCart(ctx context.Context, in *RemoveFromCartRequest, opts ...grpc.CallOption) (*CartBoolResponse, error)
	ClearCart(ctx context.Context, in *ClearCartRequest, opts ...grpc.CallOption) (*CartBoolResponse, error)
...
func (c *cartServiceClient) AddToCart(ctx context.Context, in *AddToCartRequest, opts ...grpc.CallOption) (*CartBoolResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CartBoolResponse)
...
func (c *cartServiceClient) RemoveFromCart(ctx context.Context, in *RemoveFromCartRequest, opts ...grpc.CallOption) (*CartBoolResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CartBoolResponse)
...
func (c *cartServiceClient) ClearCart(ctx context.Context, in *ClearCartRequest, opts ...grpc.CallOption) (*CartBoolResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CartBoolResponse)
...
type CartServiceServer interface {
	AddToCart(context.Context, *AddToCartRequest) (*CartBoolResponse, error)
	RemoveFromCart(context.Context, *RemoveFromCartRequest) (*CartBoolResponse, error)
	ClearCart(context.Context, *ClearCartRequest) (*CartBoolResponse, error)
...
func (UnimplementedCartServiceServer) AddToCart(context.Context, *AddToCartRequest) (*CartBoolResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddToCart not implemented")
}
func (UnimplementedCartServiceServer) RemoveFromCart(context.Context, *RemoveFromCartRequest) (*CartBoolResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RemoveFromCart not implemented")
}
func (UnimplementedCartServiceServer) ClearCart(context.Context, *ClearCartRequest) (*CartBoolResponse, error) {
...
var CartService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cart.external.v1.CartService",
